...
$(document).ready(function(){
    var $table = $("#manufacturer_tb");
    var table = $table.dataTable( {
        "ajax":{
            url: urls.manufacturer.list,
...
//                        '</a>' +
    ...
    $("#add_btn").on('click',function(){
        window.location = urls.manufacturer.add;
    });
    ...
    $table.find("tbody").delegate(".edit", 'click', function () {
        var id = $(this).data("id");
        window.location = urls.manufacturer.edit+"?id="+id;
    } );
    ...
    var _delete = function(ids){
        ...
        $.messager.confirm(title, message, function() {
            post(urls.manufacturer.delete,{ids:ids},function(){
