...
//                        '</a>' +
    ...
    $("#add_btn").on('click',function(){
        window.location = urls.product.add;
    });

    $("#delete_btn").on('click',function(){
       var ids = [];
        $("#product_tb tbody").find("input:checkbox").each(function(index){
    ...
    $("#product_tb tbody").delegate(".edit", 'click', function () {
        var id = $(this).data("id");
        window.location = urls.product.edit+"?id="+id;
    } );
    $("#product_tb tbody").delegate(".delete", 'click', function () {
        var id = $(this).data("id");
        var ids = [];
        ids.push(id);
        _delete(ids);
    ...
    var _delete = function(ids){
        ...
        $.messager.confirm(title, message, function() {
            post(urls.product.delete,{ids:ids},function(){
